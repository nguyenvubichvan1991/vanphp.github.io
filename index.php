...
<body>
    <div id="wraper">
        ...
        <div id="cottrai">
			...
			<P><a href="https://dlb16ht201.herokuapp.com/user.php" target="body" class="nhanmanh" style="font-size: 12px">Quản lý người dùng </a> </P>
			<p><a href="https://dlb16ht201.herokuapp.com/nangluc.php" target="body">Quản lí năng lực</a></p>
			<p><a href="https://dlb16ht201.herokuapp.com/truonghoc.php" target="body">Quản lý trường học</a></p>	
        </div>
        <div id="cotgiua">
            <br />
            <br />
