...
<body>
    <div id="top">
        <a href="#" style="text-decoration:none; background-color:yellow; font-size:24px">
		 <BR/>HỆ THỐNG GỢI Ý TRƯỜNG HỌC THEO NĂNG LỰC, SỞ THÍCH</a>
    </div>
    <div id="menu">
        <ul>
            ...
            <li><a href="#">Thống kê kết quả</a></li>
			...
			<form name="dangnhap_dk" method="post" action="nangluc.php" target="body" style="">
				 <table style="width: 100%;" id="w3s" href="Đăng nhập thành công">
					<tr>
						...
						<td>
							<input type="text" class="form-control" style="width:50%;" placeholder="Username" 
